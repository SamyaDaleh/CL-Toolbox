...
public class SrcgCykBinary extends AbstractDynamicDeductionRule {
  ...
  @Override public List<Item> getConsequences() {
    if (antecedences.size() == antneeded) {
      ...
      // I think it's like unary but variables can be found in both rhs and
      // vectors can come from both. Their order doesn't matter.

      if (nt1.equals(clause.getRhs().get(0).getNonterminal())
        && nt2.equals(clause.getRhs().get(1).getNonterminal())) {
