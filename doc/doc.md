...
### Adding a new Grammar Formalism

How to add a new grammar formalism to the Toolbox:

You might need to create a grammar parser first if you use a new formalism. 
...
1. Create deduction rule classes (without axioms):
    1. Create a new package for the algorithm at a reasonable position within 
    `com.github.samyadaleh.cltoolbox.chartparsing` to keep the Toolbox well-structured.
